 ...
 */
export default function buildImageUrl(url: { domain: string; directory: string; id: string; size: number; name: string; format: string; query: { [s: string]: unknown; } | ArrayLike<unknown>; }) {
	if (!url || !url.domain) {
